      ...
      {getSubtree({ asChild, children }, (children) => (
        <span
          className={cx(
            ...
            // selected
            "group-data-[active]:border-elevia-sapphire group-data-[active]:text-elevia-sapphire",
            "group-data-[active]:dark:border-elevia-azure group-data-[active]:dark:text-elevia-azure",
            // disabled
            disabled
